...
/**
 * Абстрактный класс перетаскиваемого и изменяемого по размеру заголовока DataGrid
 * @author HafizovAR
 *
 * @param <T>
 */
public abstract class ResizableHeader<T> extends Header<String> {
    ...
    private static final String MOVE_tt = "Нажмите и перетащите, чтобы переместить колонку";
    private static final String RESIZE_tt = "Нажмите и перетащите, чтобы изменить размер столбцов";
    ...
    private static final int RESIZE_HANDLE_WIDTH = 15;
