package org.tatasu.gwt.client.cawidgets.dialogbox;


import org.tatasu.gwt.client.cawidgets.dialogbox.event.DialogBoxExtCloseEvent;
import org.tatasu.gwt.client.cawidgets.dialogbox.event.DialogBoxExtCloseEventHandler;
...
public class DialogBoxExt extends DialogBox {
         ...
         */
        public DialogBoxExt(Widget closeDialogBox, Boolean autoHide) {
                super(autoHide);
        ...
        private class DialogBoxCloseHandler {
                public void onClick(Event event) {
                	DialogBoxExtCloseEvent evt = new DialogBoxExtCloseEvent();
                	fireEvent_custom(evt);
                    hide();
                }
        }
        ...
        //������������� ������� ����������� , ��� ������������ ������ fireEvent - �� �������� ��������������.
        public void fireEvent_custom(GwtEvent<?> event) {           
			handlerManager.fireEvent(event);
        }
        
        //����������� ����������� �������� ����
        public HandlerRegistration addCloseDlgEventHandler(DialogBoxExtCloseEventHandler handler) {
            return handlerManager.addHandler(DialogBoxExtCloseEvent.TYPE, handler);
        }
}